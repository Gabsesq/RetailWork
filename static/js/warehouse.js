...
function handleSkuInput(event) {
    try {
        ...
        console.log('SKU Input detected:', inputValue, 'Length:', inputValue.length);
        addDebugMessage('SKU Input: ' + inputValue + ' (' + inputValue.length + ' chars)');
        
        if (!inputValue) {
            console.log('Empty SKU input, clearing row');
...
function createDebugPanel() {
    ...
    // Show panel by default on mobile
